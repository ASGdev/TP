...
#???NB : Les resultat sont ?trange car le joueur algo perd systimatiquement contre le joueur biais? (1/4 1/4 1/2), alors que ce devrais être l'inverse (notre joueur aura tendance a jouer le counter de C donc A)
