...
#???NB : Les resultat sont comme escomptÈ car le joueur algo gagne systÈmatiquement contre le joueur biaisÈ (1/4 1/4 1/2) (notre joueur aura tendance a jouer le counter de C donc A)
...
#???Affiche un graph en fonction d'un nombre n de coup jouer, et le nombre de victorie au fur et a mesure de la partie ! On vois que l'algorythme bas le plus souvent l'algo alÈatoire biaisÈ
